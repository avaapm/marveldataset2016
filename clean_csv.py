...
df = pd.read_csv('/home/jovyan/marveldataset2016/marvel_dataset.csv', names=['image_path','class_name','name', 'bbox', 'conf_score'])
df = df[df['bbox'] != '[]']
df.to_csv('/home/jovyan/marveldataset2016/marvel_dataset_clean2.csv', index=False, header=None)